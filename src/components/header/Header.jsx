...
//       <nav className="bg-cyan-900 backdrop-blur-sm
//        max-w-6xl mx-auto rounded-full px-5 py-7 h-24 shadow-lg border border-slate-700/50">
...
//               <NavLink 
//                 to="/" 
//                 className="px-3 py-2 text-white hover:bg-gray-800  rounded-full text-xl md:text-2xl transition-colors duration-300"
//               >
//                 Home
//               </NavLink>
//             </li>
